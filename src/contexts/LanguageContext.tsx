...
const translations = {
  de: {
    ...
    'nav.contact': 'KoKontaktieren Sie unstakt',
    'nav.getStarted': 'Legen Sie los',
    'nav.language': 'Sprache',
    
    // Home Section
    'home.title': 'Verwandeln Sie Ihr',
    'home.span': 'Rezeption',
    'home.cta': 'Erlebnis',
    ...
    'about.img1': 'Über 10 Jahre Erfahrung mit Front-Desk-Lösungen',
    'about.head': 'Warum Frontdesk?',
    ...
    'services.txt4': 'Best Practices: Empfehlungen zur Umsetzung von Best Practices im Nachtmanagement.',
    ...
    'services.txt10': 'Compliance: Sicherstellung der Einhaltung gesetzlicher Vorschriften und Tarifverträge.',
    ...
    'services.txt14': 'Feedbackschleifen: Implementierung von Feedbacksystemen zur kontinuierlichen Prozessverbesserung.',
    ...
    'services.txt18': 'Mitarbeiterzufriedenheit: Verbesserung der Arbeitsbedingungen und Förderun.',

    // Contact Section
    'contact.title': 'Kontaktieren Sie uns',
    'contact.subtitle': 'Haben Sie Fragen oder möchten Sie Ihren Empfang umgestalten? Kontaktieren Sie unser Team noch heute.',
  ...
  en: {
    ...
    'about.img1': 'Over 10 years of experience with front desk solutions',
    'about.head': 'Why Frontdesk?',
    ...
    'services.txt4': 'Best Practices: Recommendations for implementing best practices in night management.',
    ...
    'services.txt10': 'Compliance: Ensuring compliance with legal regulations and collective bargaining agreements.',
    ...
    'services.txt14': 'Feedback Loops: Implementing feedback systems for continuous process improvement.',
    ...
    'services.txt18': 'Employee Satisfaction: Improving working conditions and promoting employee productivity.',
    
    // Contact Section
    'contact.title': 'Contact Us',
    'contact.subtitle': 'Do you have any questions or would you like to redesign your reception? Contact our team today.',
